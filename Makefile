...
SOURCES		:=	src src/game src/io src/io/gfx src/jj1bonuslevel \
                src/jj1bonuslevel/jj1bonuslevelplayer src/jj1level \
                src/jj1level/jj1event src/jj1level/jj1levelplayer src/jj1planet \
                src/jj1scene src/jj2level src/jj2level/jj2event \
                src/jj2level/jj2levelplayer src/level src/menu src/player
DATA		:=	data
ICON		:=	icon.jpg
INCLUDES	:=	src
#ROMFS		:=	romfs
